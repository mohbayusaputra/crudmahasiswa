                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis_kelamin" id="jenis_kelamin" value="<?= $mahasiswa['jenis_kelamin']; ?>"
                                class="form-control">
                                <option value="Laki-laki" <?php if ($mahasiswa['jenis_kelamin'] == "Laki-laki") {
                                    echo "selected";
                                } ?>>Laki-laki</option>
                                <option value="Perempuan" <?php if ($mahasiswa['jenis_kelamin'] == "Laki-laki") {
                                    echo "selected";
                                } ?>>Perempuan</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" value="<?= $mahasiswa['email']; ?>" class="form-control"
                                id="email" placeholder="Email" value="<?= set_value('email'); ?>">
